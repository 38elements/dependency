...
The framework source code is available here: [example/web_framework.py](example/web_framework.py)
...
The framework source code is available here: [example/test_framework.py](example/test_framework.py)
